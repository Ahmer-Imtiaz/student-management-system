...
void DataSeed()
{
    ...
    strcpy(Students[0].ID,"Student-1");
    strcpy(Students[0].Name,"Ahmer");
    strcpy(Students[0].Phone,"03312122323");
    strcpy(Students[0].Email,"ahmer@gmail.com");
    Students[0].NumberOfCourse=1;

    strcpy(Courses[0].StudentID,"Student-1");
    strcpy(Courses[0].Code,"PF-1");
    strcpy(Courses[0].Name,"Programming Fundamentals");

    //-- student 2
    strcpy(Students[1].ID,"Student-2");
    strcpy(Students[1].Name,"Asad");
    strcpy(Students[1].Phone,"0323234418");
    strcpy(Students[1].Email,"asad@gmail.com");
    Students[1].NumberOfCourse=2;

    strcpy(Courses[1].StudentID,"Student-2");
    strcpy(Courses[1].Code,"Cal-1");
    strcpy(Courses[1].Name,"Calculus");

    strcpy(Courses[2].StudentID,"Student-2");
    strcpy(Courses[2].Code,"CSE-2");
    strcpy(Courses[2].Name,"Fundamentals of Computer System Engineering");


    //-- student 3
    strcpy(Students[2].ID,"Student-3");
    strcpy(Students[2].Name,"Anas");
    strcpy(Students[2].Phone,"0341267612");
    strcpy(Students[2].Email,"anas@gmail.com");
    Students[2].NumberOfCourse=3;

    strcpy(Courses[3].StudentID,"Student-3");
    strcpy(Courses[3].Code,"PF-1");
    strcpy(Courses[3].Name,"Programming Fundamentals");

    strcpy(Courses[4].StudentID,"Student-3");
    strcpy(Courses[4].Code,"CSE-2");
    strcpy(Courses[4].Name,"Fundamentals of Computer System Engineering");

    strcpy(Courses[5].StudentID,"Student-3");
    strcpy(Courses[5].Code,"Calc");
    strcpy(Courses[5].Name,"Calculus");
